...
- Name: tests\e2e\workspace-open.spec.ts >> Open Workspace / Open Folder >> should enable Search tab after workspace is open
- Location: tests\e2e\workspace-open.spec.ts:84:3
