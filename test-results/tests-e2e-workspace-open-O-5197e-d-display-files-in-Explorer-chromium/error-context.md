...
- Name: tests\e2e\workspace-open.spec.ts >> Open Workspace / Open Folder >> should open folder and display files in Explorer
- Location: tests\e2e\workspace-open.spec.ts:56:3
